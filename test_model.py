...
x_ = tf.compat.v1.placeholder(tf.compat.v1.float32, [None, IMAGE_SIZE])
...
with tf.compat.v1.Session(config=config) as sess:
    ...
    originals_dir = dped_dir + phone.replace("_orig", "") + "/test_data/full_size_original_images/"
    ...
    if phone.endswith("_orig"):
        ...
        for photo in test_photos:
            ...
            misc.imsave("visual_results/" + phone + "_" + str(photo_name) + "_enhanced.png", enhanced_image)
            misc.imsave("visual_results/" + phone + "_" + str(photo_name) + "_before_after.png", before_after)
